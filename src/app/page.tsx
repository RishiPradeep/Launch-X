  ...
  return (
    <>
      <main className="overflow-x-clip">
        <div className="min-h-screen bg-homepagebg bg-fixed">
          <NavBar />
          <div>
          ...
          <div className="max-w-3xl p-5 ml-20">
            <ul className="list-disc text-xl text-gray-200">
              ...
              <li className="p-3">
                ...
                about the mysteries of the universe, our user-friendly platform
                offers real-time updates and detailed information on upcoming,
                ongoing, and past launches.
              </li>
              <li className="p-3">
